...
class RippleJsonDecoder extends JsonDecoder {
  ...
  static final Map<String, Function> _revivers = {
      ...
      "AffectedNodes": _objectListConverter,
  ...
  static Function _objectListConverter = (List objectList) =>
      new List.from(objectList.map(_objectConverter));

  static Function _objectConverter = (Map object) => object[object.keys.first];
